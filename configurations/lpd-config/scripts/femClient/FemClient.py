...
#            self.femSocket.connect((hostAddr))
    ...
    def getStatus(self):
#        return self.read(FemTransaction.BUS_RAW_REG, FemTransaction.WIDTH_LONG, 0xfbad, 0x1):
    
    def collectData(self):
#       self.write(FemTransaction.BUS_RAW_REG,FemTransaction.WIDTH_LONG, 0xface,(0x1234,))
