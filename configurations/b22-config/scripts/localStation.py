...
#
print "===================================================================";
print "Performing beamline specific initialisation code (b22).";
print
...
gdaScriptDir = "/dls_sw/b22/software/gda/config/scripts/"
gdascripts = "/dls_sw/b22/software/gda/workspace_git/gda-core.git/uk.ac.gda.core/scripts/gdascripts/"
...
class DelayedDisplayEpicsPVClass(DisplayEpicsPVClass):

	def isBusy(self):
		if super(DelayedDisplayEpicsPVClass, self).rawGetPosition() < self.threshold:
			return True
		return False

	def rawGetPosition(self):
		sleep(self.settletime)
		return super(DelayedDisplayEpicsPVClass, self).rawGetPosition()
		
ftir1=DelayedDisplayEpicsPVClass('ftir1', 'BL22B-EA-FTIR-01:AMPL', '', '%5.5g')
ftir1.settletime=2
ftir1.threshold=0.5
ftir2=DelayedDisplayEpicsPVClass('ftir2', 'BL22B-EA-FTIR-02:AMPL', '', '%5.5g')
ftir2.settletime=2
ftir2.threshold=0.5
