...
public class BioSAXSISPyBTest {
	...
	public void testcreateMeasurementsAndRegisterBufferForSample()
			throws SQLException {
		// These steps will be done prior to the experiment being run (in the init module of the BSSC.py)
		...
		long specimenId = bioSAXSISPyB.createSpecimenForMeasurement(); //FIXME takes no parameters, makes no sense
		...
		// These steps will be done when the experiment is being run (in the run module of the BSSC.py)
		...
		// FIXME this doesn't test anything. We need to call these before and after being finished
